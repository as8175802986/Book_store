...
namespace Repository_Layer.Services
{
    public class MsMq
    {
        ...
        private void Msmq_ReceiveCompleted(object sender, ReceiveCompletedEventArgs e)
        {
            ...
            MailMessage message = new MailMessage("rish0498@gmail.com", mailReceiver);
            string bodymessage = "for reset click here <a href='https://localhost:44357/'> click me</a>" +
            ...
            System.Net.NetworkCredential basicCredential1 = new System.Net.NetworkCredential("rish0498@gmail.com", "Rishu@1234");//vallid email and password
